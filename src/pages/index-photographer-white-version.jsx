...
const IndexPhotographerPage = ({ data }) => {
    ...
    return (
        <Layout
            pageTitle="Home Photographer"
            className="white-version home-classic"
        >
            <Header
                data={{
                    ...data.header,
...
export const query = graphql`
    query PhotographerWhitePageQuery {
        site {
            ...Site
        }
        header: general(section: { eq: "header-3-white" }) {
            ...Header01
        }
        ...
        homePage(title: { eq: "photographer-home-white" }) {
            content {
                ...Content01
            }
        }
